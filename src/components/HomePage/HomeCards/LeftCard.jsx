...
<><div className="card  border border-secondary ms-md-4 rounded-3">
      ...
      <div className="card-body">
       ...
       <div className="card border border-secondary ms-md-4 rounded-3 d-flex flex-column mt-3 "><div className='ms-3 mt-3'><div className='d-flex flex-row'><i className="bi bi-bookmark-fill"></i><p className='fw-bold ms-3'>Elementi salvati</p></div><div className='d-flex flex-row'><i className="bi bi-people-fill"></i><p className='fw-bold ms-3'>Gruppi</p></div><div className='d-flex flex-row'><i className="bi bi-newspaper"></i><p className='fw-bold ms-3'>Newsletter</p></div><div className='d-flex flex-row'><i className="bi bi-calendar"></i><p className='fw-bold ms-3'>Eventi</p></div></div></div> </>
    )
};
